#
#  Be sure to run `pod spec lint LZCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/carlsworld/CLPCode.git", :tag => "0.0.1" }
  ...
  s.source_files  = "CLPCode/Class/Kit/CLPhotoBrowser/*.{h,m}"
